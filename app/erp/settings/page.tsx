    ...
    <div className="space-y-6">
      ...
      {activeTab === 'profile' && (
        <div className="space-y-6">
          ...
          <Card variant="bordered">
            <div className="p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-6">Avatar</h3>
                  ...
                  <div className="shrink-0">
                    <div className="relative">
                      <img
                        src={logoPreview}
                        alt="Company Logo"
                        className="h-32 w-32 rounded-lg border-2 border-gray-200 object-cover shadow-md"
                      />
                    </div>
                  </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">MacBook Pro - Current Session</p>
        ...
        <div className="space-y-6">
          ...
          <Card variant="bordered">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Portal Features</h3>
                  <p className="text-sm text-gray-500">Enable or disable features available to employees</p>
                </div>
                <a 
                  href="/employee" 
                  target="_blank"
          ...
          <Card variant="bordered">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Portal Roles</h3>
                  <p className="text-sm text-gray-500">Manage roles and their feature permissions</p>
                </div>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                {portalRoles.map((role) => (
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-400">{role.employeeCount} employee(s) assigned</p>
                  </div>
                ))}
              </div>
              ...
              {selectedRole && (
                <div className="mt-6 pt-6 border-t">
                  ...
                  <div className="grid gap-3 md:grid-cols-2">
                    {features.map((feature) => (
                      <label key={feature.id} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer">
                        <input 
                          type="checkbox" 
          ...
          <Card variant="bordered">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Employee Role Assignments</h3>
                  <p className="text-sm text-gray-500">Assign portal roles to employees</p>
                </div>
                <Input 
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b text-left">
                      ...
                      <th className="pb-3 font-medium text-gray-500">Current Role</th>
                      <th className="pb-3 font-medium text-gray-500">Portal Access</th>
                  ...
                  <tbody>
                    {mockEmployees.map((employee) => (
                      <tr key={employee.id} className="border-b">
                        ...
                        <td className="py-4">
                          <select 
                            className="text-sm border border-gray-300 rounded-md px-2 py-1 focus:ring-green-500 focus:border-green-500"
              ...
              <div className="pt-6 border-t mt-6 flex justify-between items-center">
                <p className="text-sm text-gray-500">{mockEmployees.length} employees with portal access</p>
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Track employee portal usage and changes</p>
                </div>
