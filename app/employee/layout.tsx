...
import { mockEmployees, mockUsers, mockNotifications } from '@/lib/mock-data';
...
// Current employee (Sarah Chen - emp-002)
      ...
      >
        <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200">
          <Link href="/employee" className="flex items-center">
            <span className="text-xl font-bold text-green-600">Largify</span>
            <Badge variant="secondary" className="ml-2 text-xs">Portal</Badge>
          </Link>
          <button
            onClick={() => setSidebarOpen(false)}
      ...
      <div className="lg:pl-64 flex flex-col min-h-screen">
        ...
        <header className="sticky top-0 z-30 flex items-center h-16 px-4 bg-white border-b border-gray-200 gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/erp"
              className="hidden sm:flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-gray-600 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors"
            >
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-gray-200">
              <div className="hidden sm:block text-right">
                <p className="text-sm font-medium text-gray-900">{currentUser?.fullName || 'Employee'}</p>
                <p className="text-xs text-gray-500">{currentEmployee?.position || 'Employee'}</p>
              </div>
              <Avatar
                src={currentUser?.avatarUrl}
                alt={currentUser?.fullName || 'Employee'}
